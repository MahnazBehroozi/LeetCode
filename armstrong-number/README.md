<h2>1134. Armstrong Number</h2><h3>Easy</h3><hr><div><p>The k-digit number <code>N</code> is an Armstrong number if and only if the k-th power of each digit sums to N.</p>
